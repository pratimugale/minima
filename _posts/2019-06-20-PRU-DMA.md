...
-------
<br>
The first example I'm going to start with is the PWM example. The inputs can be written to the shared memory via the sysfs entries for the dma driver.<br> Then the PRUs can read the shared memory and change the ouput accordingly.
