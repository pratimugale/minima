...
Findings I made using single step on the `pwm-assembly` in my repo:
* Using the above caculation, the period of PWM will be 1s if 
  (0x00010000) -> 0x80 <br>
  (0x00010001) -> 0xF0 <br>
  (0x00010002) -> 0xFA <br>
  (0x00010003) -> 0x02 <br>
  ...
  (0x00010007) -> 0xF5 <br>
  (0x00010008) -> 0x05 <br>
  i.e. For this example, the ON_Cycles input is 500000000 and Total_cycles = 100,000,000
  100,000,000 * 2 = 200,000,000 (2 instructions per on/off step)
  200,000,000 * 5ns per step = 2 * 10^8 * 5 * 10^-9 seconds = 1 second time period. 
